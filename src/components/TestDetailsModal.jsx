...
const defaultTest = {
  ...
  reviewsData: [
    ...
    { 
      name: "Dmitry Petrov", 
      rating: 4.5, 
      text: "Good experience overall. The waiting time was a bit longer than expected.", 
      date: "10 March 2025" 
    },
    { 
      name: "Amina Kassym", 
      rating: 5, 
      text: "Excellent service and clean facilities. Would recommend to friends.", 
      date: "5 March 2025" 
    }
  ]
};
...
const TestDetailsModal = ({ open, handleClose, test = {} }) => {
  ...
  const renderDetailsTab = () => (
    <>
      ...
      <Box component="ul" sx={{ pl: 2, mb: 3, '& li': { mb: 1.5, pl: 1, lineHeight: 1.6 } }}>
  ...
  const renderScheduleTab = () => (
    <Box p={3} bgcolor="rgba(0, 0, 0, 0.03)" borderRadius={2} borderLeft={`4px solid ${primaryColor}`}>
      <Typography variant="subtitle1" fontWeight="bold" mb={3}>Choose Date and Time</Typography>
      ...
      <Box bgcolor="white" p={3} borderRadius={2} mb={3} boxShadow="0px 2px 8px rgba(0, 0, 0, 0.1)">
        <Typography variant="subtitle2" color="text.secondary" mb={2}>Order Summary</Typography>
          ...
          <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
            ...
            <Box display="flex" gap={2}>
              <Button 
                ...
                onClick={toggleBookmark} 
                sx={commonButtonStyle}
                startIcon={isBookmarked ? <FavoriteIcon sx={{ color: primaryColor }} /> : <FavoriteBorderIcon />}
              >
